...
export const apps: App[] = [
  ...
  },
  {
    slug: 'heum',
    group: 'live',
    status: { ko: '웹 스튜디오 · 상담 가능', en: 'Web studio · Inquiries open' },
    kind: { ko: '로컬 비즈니스 웹 스튜디오', en: 'Local business web studio' },
    accent: '#3F66F5',
    ...
    copy: {
      ko: {
        name: 'HEUM',
        shortName: 'HEUM',
        tagline: '가게의 좋은 첫인상, 웹에서도 이어지게.',
        description: '카페, 식당, 작은 가게의 분위기와 메뉴, 위치, 예약, 문의를 한 주소에 담는 로컬 비즈니스 웹 스튜디오입니다.',
        proof: '업종별 제작 예시를 공개하고 실제 제작 상담을 받고 있습니다.',
      },
      en: {
        name: 'HEUM',
        shortName: 'HEUM',
        tagline: 'Carry a great first impression onto the web.',
        description: 'A local business web studio bringing a place’s character, menu, location, reservations, and inquiries into one clear address.',
        proof: 'Business-specific production examples are live and inquiries are open.',
      },
    },
  },
  {
